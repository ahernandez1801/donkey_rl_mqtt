...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--sim",
        type=str,
        default="/home/andy/DonkeySim/Donkey.x86_64",
    ...
    parser.add_argument(
        "--env_name", type=str, default="DonkeySim-v1", help="name of donkey sim environment", choices=env_list
    )

    parser.add_argument('--teleop', action='store_true', default=False,
                    help='Use teleoperation for training')
    parser.add_argument('--donkey_name', default='',
                    help='Use this real donkey robot for training')
    parser.add_argument('--broker', default='')
    parser.add_argument('--max_cte', type=int, default=10)
    parser.add_argument('--level', type=str, default="generated_track", choices=level_list)
